...
class DataLoader(object):
    ...
    def __init__(self, data_dir, subset, batch_size, rng=None, shuffle=False, return_labels=False):
        ...
        print(self.data.shape, self.data.max(), self.data.min(), 'should be (B,1,32,32), 0, 255')
        self.data = np.floor(self.data / 16)
        print(self.data.max(), self.data.min(), 'should be 0, 15')
        self.data = (self.data / 15 - 0.5) / 0.5
        print(self.data.max(), self.data.min(), 'should be -1, 1'
